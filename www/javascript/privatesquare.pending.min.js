...
'">';e+=c(i)+' at "';e+=htmlspecialchars(f.venue);e+='"</option>'}e+="</optgroup>";$("#checkins").html(e);$("#meh").click(privatesquare_pending_purge_checkins);c=$("#deferred");c.attr("data-count-pending",a.length);c.show();c.submit(privatesquare_pending_onselect);privatesquare_pending_show_map(a)}}
