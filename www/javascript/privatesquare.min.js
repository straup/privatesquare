...
function _foursquare_venues_onsuccess(a){privatesquare_unset_status();if(a.stat!="ok")navigator.geolocation.getCurrentPosition(function(f){privatesquare_deferred_checkin(f.coords.latitude,f.coords.longitude,"api error")},function(){privatesquare_api_error(a)});else{var b=a.venues.length;if(b){for(var c="",d=0;d<b;d++){var e=a.venues[d];c+='<option value="'+e.id+'">'+e.name+"</option>"}c+='<option value="-1">\u2013\u2013 none of the above / search \u2013\u2013</option>';b=$("#where");b.attr("data-crumb",
