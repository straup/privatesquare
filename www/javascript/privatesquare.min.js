...
function _foursquare_venues_onsuccess(a){privatesquare_unset_status();if(a.stat!="ok")navigator.geolocation.getCurrentPosition(function(f){privatesquare_deferred_checkin(f.coords.latitude,f.coords.longitude,"api error")},function(){privatesquare_api_error(a)});else{var b=a.venues.length;if(b){for(var c="",e=0;e<b;e++){var d=a.venues[e];c+='<option value="'+d.id+'">'+d.name+"</option>"}c+='<option value="-1">\u2013\u2013 none of the above / search \u2013\u2013</option>';b=$("#where");b.attr("data-crumb",
