...
function(){privatesquare_set_status("Huh. I have no idea where you are...")});$("#checkin").submit(privatesquare_submit);$("#again").click(privatesquare_reset);privatesquare_set_status("Asking the sky where you are...")}function privatesquare_reset(){$("#venues").hide();privatesquare_unset_status();privatesquare_hide_map();privatesquare_init()}
