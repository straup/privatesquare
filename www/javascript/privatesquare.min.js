...
function _privatesquare_geolocation_onsuccess(a){var b=a.coords.latitude;a=a.coords.longitude;!window.navigator.onLine&&_cfg.deferred_checkins?privatesquare_deferred_checkin(b,a,"offline"):privatesquare_fetch_venues(b,a)}
...
function _foursquare_venues_onsuccess(a){$("#status").html("");if(a.stat!="ok")navigator.geolocation.getCurrentPosition(function(f){privatesquare_deferred_checkin(f.coords.latitude,f.coords.longitude,"api error")},function(){privatesquare_api_error(a)});else{var b=a.venues.length;if(b){for(var c="",e=0;e<b;e++){var d=a.venues[e];c+='<option value="'+d.id+'">'+d.name+"</option>"}c+='<option value="-1">\u2013\u2013 none of the above / search \u2013\u2013</option>';b=$("#where");b.attr("data-crumb",
a.crumb);b.html(c);b.change(_privatesquare_where_onchange);$("#what").change(_privatesquare_what_onchange);_privatesquare_show_map(a.latitude,a.longitude);privatesquare_unset_status();$("#venues").show()}else{c="You appear to have fallen in to a black hole. There's nothing around here";if(a.query)c+=" that looks like <q>"+htmlspecialchars(a.query)+"</q>";c+='. <a href="#" onclick="privatesquare_search();return false;">Try again</a>';c+=' or <a href="#" onclick="privatesquare_init();return false;">start from scratch</a>?';
