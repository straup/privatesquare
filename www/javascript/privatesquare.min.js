var checking_in=false,searching=false;function privatesquare_init(){if(window.navigator.onLine){$("#navi-online").show();$("#navi-offline").hide();privatesquare_whereami(_privatesquare_geolocation_onsuccess,_privatesquare_geolocation_onerror);$("#checkin").submit(privatesquare_submit);$("#again").click(privatesquare_reset);privatesquare_set_status("Asking the sky where you are...")}else{$("#navi-online").hide();$("#navi-offline").show();privatesquare_deferred_checkin(null,null,"offline")}}
