...
function privatesquare_init(a){a||(a="foursquare");$("body").attr("data-privatesquare-provider",a);if(window.navigator.onLine)privatesquare_deferred_checkin(null,null,"offline");else{privatesquare_whereami(function(b){var c=b.coords.latitude;b=b.coords.longitude;var d=$("#venues");d.attr("data-geolocation-latitude",c);d.attr("data-geolocation-longitude",b);if(a=="stateofmind")privatesquare_stateofmind_fetch_venues(c,b);else if(a=="nypl")privatesquare_nypl_fetch_venues(c,b);else a=="privatesquare"?
privatesquare_venues_fetch_venues(c,b):privatesquare_foursquare_fetch_venues(c,b)},function(){privatesquare_set_status("Huh. I have no idea where you are...")});$("#checkin").submit(privatesquare_submit);$("#again").click(privatesquare_reset);privatesquare_set_status("Asking the sky where you are...")}}function privatesquare_reset(){$("#venues").hide();privatesquare_unset_status();privatesquare_hide_map();privatesquare_init()}
