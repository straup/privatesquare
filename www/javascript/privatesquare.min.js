...
function _privatesquare_api_error(a){a=a.error;var b="Oh noes. There was a problem completing your request. ";b+="The robot monkeys report: ";b+=a.error+" (error code #"+a.code+"). ";b+='<a href="#" onclick="privatesquare_init();return false;">Try it again?</a>';$("#status").html(b)}
