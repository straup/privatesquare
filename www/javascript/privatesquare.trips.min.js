function privatesquare_trips_datepicker_init(){$(".form-control").focus(function(){var a=$(this).attr("id");if(a=="arrival"){$("#x-calendar-arrival-wrapper").show();$("#x-calendar-departure-wrapper").hide()}else if(a=="departure"){$("#x-calendar-arrival-wrapper").hide();$("#x-calendar-departure-wrapper").show()}else{$("#x-calendar-arrival-wrapper").hide();$("#x-calendar-departure-wrapper").hide()}});document.getElementById("x-calendar-arrival-wrapper").querySelector("x-calendar").addEventListener("datetap",
function(a){a=a.detail.iso;$("#arrival").val(a)});document.getElementById("x-calendar-departure-wrapper").querySelector("x-calendar").addEventListener("datetap",function(a){a=a.detail.iso;$("#departure").val(a)})}
