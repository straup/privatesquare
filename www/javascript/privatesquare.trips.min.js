function privatesquare_trips_datepicker_init(){$("#arrival").datepicker({language:"en"});$("#departure").datepicker({language:"en"})}function privatesquare_trips_select2_init(){var a=privatesquare_abs_root_url()+"user_trips_add_geocode.php";$("#where").select2({minimumInputLength:3,ajax:{url:a,dataType:"json",data:function(b){return{q:b}},results:function(b){return{results:b.results}}}})}
