...
function _privatesquare_trips_edit_trip_onsuccess(a){if(a.stat!="ok"){privatesquare_set_status(a.error.error,"danger");return false}var b=a.trip;$("#short_name").html(b.locality.woe_name);$("#long_name").html(b.locality.name);console.log(a);privatesquare_set_status("Your trip has been updated!")}function _privatesquare_trips_delete_trip_onsuccess(a){if(a.stat!="ok"){privatesquare_set_status(a.error.error,"danger");return false}a=privatesquare_abs_root_url()+"me/trips/?deleted=1";location.href=a};
