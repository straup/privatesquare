...
var a=$("#edit-trip").attr("data-delete-trip-crumb");a={id:$("#trip").val(),crumb:a};privatesquare_api_call("privatesquare.trips.deleteTrip",a,_privatesquare_trips_delete_trip_onsuccess);privatesquare_set_status("Deleting your trip");return false})}function _privatesquare_trips_edit_trip_onsuccess(a){console.log(a)}function _privatesquare_trips_delete_trip_onsuccess(a){console.log(a)};
