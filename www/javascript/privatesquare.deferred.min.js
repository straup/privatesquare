...
function privatesquare_deferred_checkin_stored(a){console.log(a);privatesquare_set_status("Okay! Your checkin at '"+a.venue+"' has been recorded.");privatesquare_hide_map();$("#deferred_checkin").hide()}
