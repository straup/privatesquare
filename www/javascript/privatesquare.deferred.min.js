...
function privatesquare_deferred_checkin(a,c,b){a&&c&&_privatesquare_show_map(a,c);privatesquare_unset_status();if(b=="offline")b="I've lost the network";else if(b=="api error")b="foursquare is sad";if(privatesquare_deferred_has_local_storage()){privatesquare_set_status(htmlspecialchars(b)+" / write a postcard to the future?");b=$("#deferred_where");b.val("");if(a&&c){b.attr("data-latitude",a);b.attr("data-longitude",c)}else{a=$("#deferred_city");a.val("");a.show()}$("#deferred_checkin").submit(privatesquare_deferred_checkin_submit);
