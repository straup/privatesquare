<?php
	...
	function api_oauth2_access_tokens_create(&$key, &$user, $perms, $ttl=0){
		...
		$rsp = db_insert_api('OAuth2AccessTokens', $insert);
	...
	function api_oauth2_access_tokens_update(&$token, $update){
		...
		$rsp = db_update_api('OAuth2AccessTokens', $update, $where);
	...
	# Infrastructure tokens - this should be moved in to a whole other library, like site keys
