<?php
    ...
    include_once FLAMEWORK_INCLUDE_DIR . '/modestmaps/Geo.php';
    include_once FLAMEWORK_INCLUDE_DIR . '/modestmaps/Core.php';
    include_once FLAMEWORK_INCLUDE_DIR . '/modestmaps/Providers.php';
